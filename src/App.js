    ...
    const questions = [
        {
            ...
            variants: ['Правапiс д i дз, т i ц', 'Правапiс спалучэнняў галосных у запазычаных словах', 'Правапiс падоўжаных зычных'],
            correct: 2
        },
        {
            title: 'У якiх словах зычныя гукi звычайна не падаўжаюцца?',
            variants: ['Ка(лл/л)екцыя, навак(лл/ль)ое, пiсьме(н/нн)iк', 'І(лл/ль)я, У(лл/ль)яна, Ка(сс/сь)ян, Емя(лл/ль)ян, Ю(лл/ль)ян, Ю(лл/ль)яна', 'разро(с/сс)я, нямечы(нн/н)а, рва(ц/цц)а, жы(ц/цц)я'],
            correct: 1
        },
        {
        ...
        {
            title: 'У якiм становiшчы зычныя гукi могуць вымауляцца падоўжана?',
        ...
        {
            title: 'Адзначце слова, у якіх пішацца сс:',
            variants: ['па(сс/с)ажыр', 'кампрамі(сс/с)', 'ра(сс/с)удзіць'],
            correct: 2
        }
    ]
